...
typedef enum ResponseCode {
  ...
  CLIENT_READY_FILE = 206,
  FILE_TRANSFER_SUCCESS = 207,
  LIST_FILE_SUCCESS = 208,
  LIST_ROOM_SUCCESS = 209,
  JOIN_ROOM_SUCCESS = 210,
  QUIT_ROOM_SUCCESS = 211,
  MSG_ROOM_SUCCESS = 212,
  CREATE_ROOM_SUCCESS = 213,
  DELETE_ROOM_SUCCESS = 214,
