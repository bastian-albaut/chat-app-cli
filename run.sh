...
gcc -o client ./src/client.c -lpthread ./src/global.c ./src/client/global_client.c ./src/client/semaphore/semaphore_client.c ./src/client/file/list_files_client.c ./src/client/file/recv_file_client.c ./src/client/file/send_file_client.c
...
if gnome-terminal --title="Server" -- bash -c "./server 7000"; then
...
if gnome-terminal --title="Client 1" -- bash -c "./client 127.0.0.1 7000"; then
...
if gnome-terminal --title="Client 2" -- bash -c "./client 127.0.0.1 7000"; then
