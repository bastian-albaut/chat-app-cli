...
gcc -o client ./src/client.c -lpthread ./src/client_functions.c
gcc -o server ./src/server.c -lpthread ./lib/list.c ./src/server_functions.c

# Open another new terminal window and run server
if gnome-terminal --title="Server" -- bash -c "./server 6000"; then
...
if gnome-terminal --title="Client 1" -- bash -c "./client 127.0.0.1 6000"; then
...
if gnome-terminal --title="Client 2" -- bash -c "./client 127.0.0.1 6000"; then
